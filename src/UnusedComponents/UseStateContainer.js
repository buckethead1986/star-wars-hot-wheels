...
//       return {
//         ...state,
//         searchbarData: action.data !== undefined ? action.data : ""
//       };
//     case "CREATE_FILTERS":
//       // console.log(state);
//       return {
...
export default function Container() {
  ...
  // const [testShipFilter, dispatch] = useReducer(filterReducer, initialState);
  ...
  //     type: "CREATE_FILTERS"
  //   });
  //   // console.log(testShipFilter);
  // };
  //
  // const changeSearchbarData = searchbarData => {
  //   dispatch({
  ...
  return (
    <div>
      <Drawer
        ...
        handleSearchbarData={changeSearchbarData}
